...
void MainWindow::Word(QString str,QVector<int> &bit_array) // функция перевода строки в двоичный код
{
    ...
    QString smal[32]={"а","б","в","г","д","е","ж","з","и","й","к","л","м","н","о","п","р","с","т","у","ф","х","ц","ч","ш","щ","ъ","ы","ь","э","ю","я"};
    QString big[32] ={"А","Б","В","Г","Д","Е","Ж","З","И","Й","К","Л","М","Н","О","П","Р","С","Т","У","Ф","Х","Ц","Ч","Ш","Щ","Ъ","Ы","Ь","Э","Ю","Я"};
...
void MainWindow::ECB(QVector<int> &bit_array,QVector<int> &ECB_out_bit,int *K0,int *K1)
{
    ...
    for(int i = 0;i<bit_array.length();i+=5)
    {
        ...
        if(buf_array[4]==0) sum(ECB_out_bit,buf_array,K0);
...
////////////////////////////////////////////////////////////График ECB
    ...
    double h,hh=0;
       ...
       for(int i=0; i<m; i++)
           ...
           ui->ECB->yAxis->setRange(0,first_maxY); //сюда надо вставить максимальное h
...
////////////////////////////////////////////////////////////График OFB
          ...
          QVector<double> x3(m), y3(m);
             for (int i=0; i<m; i++)
                 ...
                 ui->OFB->yAxis->setRange(0,first_maxY); //сюда надо вставить максимальное h
...
////////////////////////////////////////////////////////////График CFB
             ...
             QVector<double> x4(m), y4(m);
                for (int i=0; i<m; i++)
                    ...
                    ui->CFB->yAxis->setRange(0,first_maxY); //сюда надо вставить максимальное h
...
//////////////////////////////////////////////////////////// График Текста
                ...
                QVector<double> x0(m), y0(m);
                   for (int i=0; i<m; i++)
                       ...
                       ui->textPlot->yAxis->setRange(0,first_maxY); //сюда надо вставить максимальное h
